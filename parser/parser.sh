...
if [ "$#" != "2" ]; then 
	echo "Breach-Parse v2: A Breached Domain Parsing Tool by Brian Harvey."
	echo " "
	...
	touch $master
	total_Files=$(find /home/archmendes/Desktop/paser -type f | wc -l)
	file _Count=0
	
	function ProgressBar{
		let _progress=(${file_Count}*100/4{total_Files}*100)/100
	...
	find /home/archmendes/Desktop/parser -type f -print0 | while read -d $'\0' file
